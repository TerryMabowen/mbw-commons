package com.github.mbw.commons.helper;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.github.mbw.commons.constant.SecretConstant;
import com.github.mbw.commons.kit.aes.AESSecretKit;
...
public class JwtHelper {
    ...
    public static String generateJWT(String userId, String userName, String... identities) {
        ...
        JwtBuilder builder = Jwts.builder().setHeader(headMap)
                 ...
                 */
                //加密后的客户编号
                .claim("userId", AESSecretKit.encryptToStr(userId, SecretConstant.DATAKEY))
                //客户名称
     ...
     */
    public static String validateLogin(String jsonWebToken) throws JsonProcessingException {
        Map<String, Object> retMap = null;
        Claims claims = parseJWT(jsonWebToken);
        if (claims != null) {
            //解密客户编号
            String decryptUserId = AESSecretKit.decryptToStr((String) claims.get("userId"), SecretConstant.DATAKEY);
            retMap = new HashMap<>();
            //加密后的客户编号
